...
-   [Как "запомнить" информацию без повторного рендеринга](/learn/referencing-values-with-refs)
-   [Как получить доступ к элементам DOM, управляемым React](/learn/manipulating-the-dom-with-refs)
...
-   [Как предотвратить повторное срабатывание эффектов от некоторых значений](/learn/separating-events-from-effects)
-   [Как сделать так, чтобы эффект запускался реже](/learn/removing-effect-dependencies)
-   [Как разделить логику между компонентами](/learn/reusing-logic-with-custom-hooks)

## Ссылки на значения с помощью ссылок {/_referencing-values-with-refs_/}

Когда вы хотите, чтобы компонент "запомнил" некоторую информацию, но не хотите, чтобы эта информация [запускала новые рендеры] (/learn/render-and-commit), вы можете использовать _ref_:
...
Прочитайте **[Ссылка на значения с помощью ссылок](/learn/referencing-values-with-refs)**, чтобы узнать, как использовать ссылки для запоминания информации.
...
Прочитайте **[Manipulating the DOM with Refs](/learn/manipulating-the-dom-with-refs)**, чтобы узнать, как получить доступ к элементам DOM, управляемым React.
...
Прочитайте **[Синхронизация с эффектами](/learn/synchronizing-with-effects)**, чтобы узнать, как синхронизировать компоненты с внешними системами.
...
Прочитайте **[Вы можете не нуждаться в эффектах](/learn/you-might-not-need-an-effect)**, чтобы узнать, как убрать ненужные Эффекты.
...
Прочитайте **[Жизненный цикл реактивных событий](/learn/lifecycle-of-reactive-effects)**, чтобы узнать, чем жизненный цикл эффекта отличается от жизненного цикла компонента.
...
Читайте **[Отделение событий от эффектов](/learn/separating-events-from-effects)**, чтобы узнать, как предотвратить повторное срабатывание эффектов при некоторых значениях.
...
Читайте **[Удаление зависимостей эффектов](/learn/removing-effect-dependencies)**, чтобы узнать, как сделать так, чтобы ваш эффект запускался реже.
...
Прочитайте **[Reusing Logic with Custom Hooks](/learn/reusing-logic-with-custom-hooks)**, чтобы узнать, как обмениваться логикой между компонентами.

\</LearnMore\>

## Что дальше? {/_whats-next_/}

Перейдите по ссылке [Referencing Values with Refs](/learn/referencing-values-with-refs), чтобы начать читать эту главу страница за страницей\!
