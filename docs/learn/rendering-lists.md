...
=== "Результат"
    ...
    ![Результат](rendering-lists-1.png)
...
=== "Результат"
    ...
    ![Результат](rendering-lists-2.png)
...
=== "Результат"
    ...
    ![Результат](rendering-lists-3.png)
...
!!!note "Отображение нескольких узлов DOM для каждого элемента списка"
    ...
    Короткий синтаксис [<code>&lt;&gt;...&lt;/&gt;</code> Fragment](../reference/Fragment.md) не позволит вам передать ключ, поэтому вам нужно либо сгруппировать их в один `<div>`, либо использовать немного более длинный и более явный синтаксис `<Fragment>`:
...
=== "Результат"
    ...
    ![Результат](rendering-lists-4.png)
...
???success "Показать решение"
    ...
    === "Результат"
    	...
    	![Результат](rendering-lists-5.png)
    ...
    === "Результат"
    	...
    	![Результат](rendering-lists-6.png)
...
???success "Показать решение"
    ...
    === "Результат"
    	...
    	![Результат](rendering-lists-7.png)
...
=== "Результат"
    ...
    ![Результат](rendering-lists-8.png)
...
???success "Показать решение"
    ...
    === "Результат"
    	...
    	![Результат](rendering-lists-9.png)
...
=== "Результат"
    ...
    ![Результат](rendering-lists-10.png)
...
???success "Показать решение"
    ...
    === "Результат"
    	...
    	![Результат](rendering-lists-11.png)
    ...
    В качестве альтернативы можно вывести коллекцию фрагментов, содержащих `<hr />` и `<p>...</p>`. Однако синтаксис сокращения `<>...</>` не поддерживает передачу ключей, поэтому вам придется явно написать `<Fragment>`:
