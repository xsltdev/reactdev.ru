...
_JSX_ - это расширение синтаксиса для JavaScript, позволяющее писать HTML-подобную разметку внутри файла JavaScript. Хотя существуют и другие способы написания компонентов, большинство разработчиков React предпочитают лаконичность JSX, и большинство кодовых баз используют именно его.
...
Этот пустой тег называется _[Фрагмент](/reference/react/Fragment)_. Фрагменты позволяют группировать элементы, не оставляя никаких следов в HTML-дереве браузера.
...
### 3. camelCase <s>all</s> большинство вещей!
...
Вы можете [найти все эти атрибуты в списке реквизитов компонентов DOM.](/reference/react-dom/components/common) Если вы ошибетесь, не волнуйтесь - React выведет сообщение с возможным исправлением в [консоль браузера.](https://developer.mozilla.org/docs/Tools/Browser_Console).
