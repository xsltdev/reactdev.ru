---
description: Используйте встроенный набор инструментов для лучшего взаимодействия пользователя и разработчика
---
...
Если у вас нет проблем, описанных выше, или пока не чувствуете себя уверенно, используя инструменты JavaScript, рассмотрите возможность [добавления React в виде простого тега `<script>` на HTML странице](add-react-to-a-website.md), [при необходимости с JSX](add-react-to-a-website.md#optional-try-react-with-jsx).
...
- Если вы **изучаете React** или **создаёте новое одностраничное приложение**, используйте [Create React App](#create-react-app).
...
[Create React App](https://github.com/facebookincubator/create-react-app) – удобная среда для **изучения React** и лучший способ начать создание **нового одностраничного приложения** на React.
...
Не забудьте убедиться, что ваш набор инструментов [правильно настроен для продакшена](optimizing-performance.md#use-the-production-build).
