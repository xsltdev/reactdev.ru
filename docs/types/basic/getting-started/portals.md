...
[Посмотреть в TypeScript Playground](https://www.typescriptlang.org/play/?jsx=2#-2GTuFE4HEcXowD48y0+mcAWO5FOp16igGBhQYDAqy2JWqLg6wAkBiQ8j8w1OAF8KP9AXs4gB1aryACqYhkkJg0KO-wRCyRKgMRBkjSQmOxzlx+MJxP+5JGpyIYj4SCg7Nh8LgRBgRTEtG4TGYLzeSAACtAYApRVj8WAcGB8WgsfI+HKADRwMUEokkuDS0lAA)

!!!info "Использование хуков"

    То же самое, что и выше, но с использованием крючков
...
function App() {
    ...
    return (
        <div>
            // you can also put this in your static html
            file
...
!!!info "Контекст примера"

    Этот пример основан на примере [Event Bubbling Through Portal](https://reactjs.org/docs/portals.html#event-bubbling-through-portals) из React docs.

<small>:material-information-outline: Источник &mdash; <https://react-typescript-cheatsheet.netlify.app/docs/basic/getting-started/portals></small>
