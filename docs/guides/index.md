...
<small>:date: 09.09.2025</small><br /> **[<big>Как использовать React Compiler – Полное руководство</big>](./react-compiler/index.md)**<br /> _В этом руководстве вы узнаете, как React Compiler может помочь вам писать более оптимизированные React-приложения._
