...
`input` поддерживает все [общие реквизиты элементов](components-common.md#props).

Вы можете сделать `input` управляемым, передав один из этих реквизитов:
...
Эти реквизиты `input` актуальны только для неконтролируемых входов:
...
Эти реквизиты `input` актуальны как для неконтролируемых, так и для контролируемых входов:
