...
## Вызов промисов {#invoking-promises}
...
## Вызов функций обратного вызова {#invoking-callbacks}
...
## Вызов наблюдаемых объектов {#invoking-observables}
...
## Вызов автоматов {#invoking-machines}
...
## Отправка ответов {#sending-responses}
...
## Ссылка на службы {#referencing-services}
