...
- [Вызываемые наблюдатели](communication.md#invoking-observables) (Invoked Observables) - непрерывные эффекты с течением времени, которые могут отправлять несколько событий, запускаемых сообщениями из наблюдаемого потока.
