...
Эти файлы удалять **нельзя**. _Обратите внимание:_ Вебпак обрабатывает только файлы, находящиеся в директории `src`.
...
_Обратите внимание:_ такие файлы не будут обрабатываться Вебпаком.
...
_Обратите внимание:_ регистрацию сервис-воркера следует запускать только при сборке проекта.
