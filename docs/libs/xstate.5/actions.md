...
## Объекты действий {#action-objects}
...
## Действие sendTo {#send-to-action}
...
## Действие enqueueActions {#enqueue-actions}
...
## Действие stopChild {#stop-action}
